<script lang="ts">
	export let label: 'draft' | 'late' | 'current' | 'sent' | 'paid' = 'draft';
</script>

<div
	class="inverted text-md w-20 rounded-full text-center font-bold capitalize text-pastelPurple border-pastelPurple border-1"
